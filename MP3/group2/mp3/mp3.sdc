...
create_clock -name {clk} -period 8.350 -waveform { 0.000 4.175 } [get_ports {clk}]
...
#set_multicycle_path -from [get_clocks {clk}] -to [get_pins {memory_conf|l2_cache|cache_l2_controller|*|clk memory_conf|l2_cache|cache_l2_datapath|*|*|clk memory_conf|l2_cache|cache_l2_datapath|*|*|*|*|clk0}] -setup -end 3
